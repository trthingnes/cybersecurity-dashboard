...
class HomeAssistantService(
    ...
    fun getBackupsInfo() = supervisor.getBackupsInfo().data
    ...
    fun getDeviceStates() = core.getStates().filter { devicePrefixes.any { prefix -> it.entityId.startsWith(prefix) } }
